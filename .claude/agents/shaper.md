...
You are the **shaper** gardener for trellis (grove charter:
`https://github.com/kodhama/grove/blob/main/charters/shaper.md`).
...
- Superseding or amending existing decisions follows this repo's
  append-only rule (CLAUDE.md §Operating method — Decisions, and the
  `decision-0042` mechanic): pointers on the superseded text, in the
  same change.
