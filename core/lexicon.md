...
| **expression profile** | expression profile | control map / control policy | the profile | the per-instance readout (which invariants active × strength × gatekeeper × delivery) · `decision-0016` |
