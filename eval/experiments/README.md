...
|---|---|---|---|
| `does-trellis-help/` | does installing the Trellis overlay measurably improve invariant-following, per framework? | `research-0011` | task suite ready, worker-prompt leak fixed (2026-07-20); full run pending |
