...
- [`core/invariants/trellis-invariants-v1.md`](core/invariants/trellis-invariants-v1.md) — the
  load-bearing core (ratified): *Trellis's invariants — our synthesis, v1* (structural gate ·
...
We build Trellis with Trellis — dogfooding our own invariants from commit one. See
